...
<div class="table">
    <table>
        <tbody>
            <tr>
                <td><span style="font-weight:bold;">Total de professores</span></td>
                <td></td>
                <td></td>
                ...
                if (!empty($teachers)) {
                    foreach ($teachers as $key => $t){
                        ...
                        <tr>
                            ...
                            <td>$sex</td>
                            <td>
                            <a href='./ver/professor?officer_id=$id&year_id=$year_id' class='btn-primary'>
                            ...
                            <td>   
                                <a href='./editar/professor?officer_id=$id&year_id=$year_id' class='btn-warning'>
                    ...
                    echo "
                        <tr>
                            <td style='padding-left:.5em;'>Não foram encontrados professores</td>
                        </tr>
                        ";
                }
                 ?>
